...
namespace DBapplication
{
    public class DBManager
    {
        ...
        static string DB_Connection_String = @"Data Source=DESKTOP-OK82552;Initial Catalog=RecipeHubDB;Integrated Security=True;Encrypt=False";
        ...
        public int ExecuteNonQueryyklnmkl(string query)
        {
            try
            {
